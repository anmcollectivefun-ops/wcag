...
const pages = [["/","home"],["/audyt.html","audit"],["/szkolenia.html","training"],["/baza-wiedzy.html","knowledge"],["/baza-wiedzy/deklaracja-dostepnosci-eaa.html","knowledge-eaa"],["/o-nas.html","about"],["/kontakt.html","contact"]];
...
try {
  ...
  const outcome = {
    ...
    scope: 'Siedem publicznych stron ANM Access przy 1280 i 320 CSS px oraz globalny tryb AAA/200% przy 320 CSS px.',
